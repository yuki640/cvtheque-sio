...
unset($__errorArgs, $__bag); ?>"
                                       id="naissance"
                                       name="naissance" 
                                       value="<?php echo e(old('naissance')); ?>"
...
unset($__errorArgs, $__bag); ?>" id="formation" name="formation">
                                    <option value="1" <?php echo e(old('formation', isset($professionnel) ? $professionnel->formation : '') == 1 ? 'selected' : ''); ?>>Oui</option>
                                    <option value="0" <?php echo e(old('formation', isset($professionnel) ? $professionnel->formation : '') == 0 ? 'selected' : ''); ?>>Non</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" type="checkbox" id="domaine1" name="domaine[]" value="S" <?php echo e(in_array('S', old('domaine', isset($professionnel) ? explode(',', $professionnel->domaine) : [])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" type="checkbox" id="domaine2" name="domaine[]" value="R" <?php echo e(in_array('R', old('domaine', isset($professionnel) ? explode(',', $professionnel->domaine) : [])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" type="checkbox" id="domaine3" name="domaine[]" value="D" <?php echo e(in_array('D', old('domaine', isset($professionnel) ? explode(',', $professionnel->domaine) : [])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="metier_id" name="metier_id">
                                ...
                                <?php $__currentLoopData = $metiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($metier->id); ?>" <?php echo e(old('metier_id') == $metier->id ? 'selected' : ''); ?>><?php echo e($metier->libelle); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control <?php $__errorArgs = ['competences_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="competences_id" name="competences_id[]" multiple>
                                    <?php $__currentLoopData = $competences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $competence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($competence->id); ?>"
                                         <?php echo e(in_array($competence->id, old('competences_id', [])) ? 'selected' : ''); ?>>
                                         <?php echo e($competence->intitule); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['competences'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('cvtheque', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\cvtheque-sio\V0-2\resources\views/professionnels/create.blade.php ENDPATH**/ ?>