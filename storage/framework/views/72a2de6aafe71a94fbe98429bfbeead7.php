...
unset($__errorArgs, $__bag); ?>" id="prenom" name="prenom" value="<?php echo e(old('prenom')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="nom" name="nom" value="<?php echo e(old('nom')); ?>">
                            <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['cp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="cp" name="cp" value="<?php echo e(old('cp')); ?>">
                            <?php $__errorArgs = ['cp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="ville" name="ville" value="<?php echo e(old('ville')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <label for="telephone" class="col-form-label">N° de Téléphone :</label>
...
unset($__errorArgs, $__bag); ?>" id="telephone" name="telephone" value="<?php echo e(old('telephone')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="date_naissance" name="date_naissance" value="<?php echo e(old('date_naissance')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control <?php $__errorArgs = ['domaine'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="domaine" name="domaine">
...
unset($__errorArgs, $__bag); ?>" id="metier_id" name="metier_id">
                                <?php $__currentLoopData = $metiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($metier->id); ?>"><?php echo e($metier->libelle); ?></option>
