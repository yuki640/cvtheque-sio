                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" readonly="" class="form-control" id="competences_id"
                                        name="competences_id" value="<?php echo e($professionnel->competences->implode('intitule', ', ')); ?>">
                                </div>
                        </div>
...
<?php echo $__env->make('cvtheque', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\cvtheque-sio\V0-2\resources\views/professionnels/sup.blade.php ENDPATH**/ ?>