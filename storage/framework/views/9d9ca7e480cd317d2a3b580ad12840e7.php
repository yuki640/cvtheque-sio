...
unset($__errorArgs, $__bag); ?>" id="competences_id" name="competences_id[]" multiple>
                                <?php $__currentLoopData = $competences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $competence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php echo e(in_array($competence->id, old('competences_id', isset($professionnel) ? $professionnel->competences->pluck('id')->toArray() : [])) ? 'selected' : ''); ?>>
                                        <?php echo e($competence->intitule); ?>

                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['competences_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('cvtheque', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\cvtheque-sio\V0-2\resources\views/professionnels/edit.blade.php ENDPATH**/ ?>